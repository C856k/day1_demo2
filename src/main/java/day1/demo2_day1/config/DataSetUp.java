package day1.demo2_day1.config;
...
public class DataSetUp implements ApplicationRunner {
    ...
    public DataSetUp(PlayerReporsitory playerReporsitory) {
        this.playerReporsitory = playerReporsitory;
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        playerReporsitory.saveAll(players);
